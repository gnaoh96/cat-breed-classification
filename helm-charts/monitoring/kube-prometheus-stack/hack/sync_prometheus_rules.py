...
charts = [
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/alertmanager-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/kubePrometheus-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/kubernetesControlPlane-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/kubeStateMetrics-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/nodeExporter-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/prometheus-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
    {
        "source": "https://raw.githubusercontent.com/prometheus-operator/kube-prometheus/%s/manifests/prometheusOperator-prometheusRule.yaml"
        % (refs["ref.kube-prometheus"],),
        "destination": "../templates/prometheus/rules-1.14",
        "min_kubernetes": "1.14.0-0",
    },
